...
import kotlinx.android.synthetic.main.activity_respon_fragment.*

class DetailNotRespon : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_detail_not_respon)
        ...
        val ic_btn_process = findViewById<ImageView>(R.id.ic_btn_process)
